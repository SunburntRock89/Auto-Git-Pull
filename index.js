...
app.post("/", async(req, res) => {
	let repo = config.repos.find(r => r.name.toLowerCase() === `${r.host == "gitlab" ? req.body.project.path_with_namespace.toLowerCase() : req.body.repository.full_name.toLowerCase()}`);
	if (!repo) return;
